...
npm run update:resource:supabase "Vocabulary: Company Finance" "company-finance-vocabulary-html.html"
npm run update:resource:supabase "Vocabulary: Publishing" "publishing-vocabulary-html.html"
...
npm run update:resource:supabase "Ridiculous English Idioms" "ridiculous-english-idioms-html.html"
...
npm run update:resource:supabase "Speaking: Environmental Responsibility" "speaking-environmental-responsibility-html.html"
...
npm run update:resource:supabase "Speaking: Card Deck Topics" "speaking-topics-html.html"
...
npm run update:resource:supabase "Listening: Disagreement and Criticism" "disagreement-and-criticism-html.html"
npm run update:resource:supabase "Reading: My Internship Experience" "reading-my-internship-experience-html.html"

# Reference
npm run update:resource:supabase "US vs UK Spelling" "us-vs-uk-spelling-html.html"
