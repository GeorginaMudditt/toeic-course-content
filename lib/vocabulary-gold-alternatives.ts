...
const GOLD_ALTERNATIVES: Record<string, string[]> = {
  ...
  'a1|Home|flat': ['apartment'],
  'a1|Home|toilet': ['WC'],
  'a1|Home|living room': ['lounge'],
  ...
  'a2|Home (A)|carpet': ['rug'],
  'a2|Home (A)|cooker': ['stove'],
  'a2|Home (A)|fridge': ['refridgerator', 'refrigerator'],
  ...
  'a2|People|aunt': ['aunty'],
  'a2|People|customer': ['client'],
  'a2|People|grandfather': ['grandpa'],
  'a2|People|grandmother': ['grandma'],
  'a2|People|kid': ['child'],
