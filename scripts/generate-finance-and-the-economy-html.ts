...
const VOCAB: ReadonlyArray<{ word: string; french: string; example: string }> = [
  ...
  { word: 'savings', french: 'épargne', example: 'Household savings can help families cope when the economy slows down.' },
...
const ANSWER_KEY: ReadonlyArray<{ sentence: string; answer: string }> = [
  { sentence: 'Banks usually require the consent of all parties before closing a __________, since either holder could otherwise be left without access to shared funds.', answer: 'joint account' },
  { sentence: 'A sudden fall on the __________ can wipe out a large part of the value of pension funds in a single day.', answer: 'stock market' },
  { sentence: 'Unable to raise enough capital from shareholders, the founders had to __________ from a specialist lender.', answer: 'borrow' },
  { sentence: 'The factory blamed rising __________ prices, especially for oil and steel, for its declining profit margins.', answer: 'commodities' },
  { sentence: 'Before approving the takeover, the board asked for an independent __________ review of the target company\'s accounts.', answer: 'financial' },
  { sentence: 'After three quarters of falling output and rising unemployment, the country was widely described as being in a __________.', answer: 'recession' },
  { sentence: 'The bank allowed a temporary __________ so the business could pay suppliers while waiting for customer invoices.', answer: 'overdraft' },
  { sentence: 'A patient __________ may accept lower short-term returns in exchange for steady long-term growth.', answer: 'investor' },
  { sentence: 'If you only pay the minimum amount on your __________ each month, your debt can grow quickly because of interest charges.', answer: 'credit card' },
  { sentence: 'The agreement was expected to boost cross-border __________ in services as well as manufactured goods.', answer: 'trade' },
  { sentence: 'For day-to-day spending, she kept her money in a __________ rather than in fixed-term deposits or a shared household account.', answer: 'current account' },
  { sentence: 'She shopped around carefully because even a small difference in the __________ rate could save thousands over the life of a mortgage.', answer: 'interest' },
  { sentence: 'The insurance __________ compared policies from several providers and recommended the best-value option.', answer: 'broker' },
  { sentence: 'Slower __________ growth forced the government to revise its public spending plans for the coming year.', answer: 'economic' },
  { sentence: 'Rather than investing the money, they decided to build up their __________ for unforeseen expenses.', answer: 'savings' },
  { sentence: 'Exporters benefited when the national __________ weakened, because their goods became cheaper for foreign buyers.', answer: 'currency' },
  { sentence: 'To buy the van, she took out a small business __________ and agreed to repay it in monthly instalments.', answer: 'loan' },
  { sentence: 'The app alerts customers when their account __________ falls below £100.', answer: 'balance' },
  { sentence: 'On the exchange floor, a __________ may buy and sell the same commodity several times in one session.', answer: 'trader' },
  { sentence: 'For the fifth year running, government spending exceeded tax revenue, leaving a significant budget __________.', answer: 'deficit' },
]
