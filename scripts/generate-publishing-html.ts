...
const VOCAB: ReadonlyArray<{ word: string; french: string; example: string }> = [
  ...
  { word: 'copyright', french: 'droit d\'auteur', example: 'The publisher asked the photographer to confirm she still held the copyright before they used her pictures on the cover.' },
  ...
  { word: 'advance', french: 'à-valoir', example: 'She used part of her advance to take three months off work and finish the second draft.' },
  ...
  { word: 'editing', french: 'révision éditoriale', example: 'The editing dragged on for weeks because the author and the editor could not agree on the last chapter.' },
  { word: 'proofreading', french: 'correction d\'épreuves', example: 'During proofreading, someone noticed that the same character\'s name was spelled two different ways on page 214.' },
  { word: 'book fair', french: 'salon du livre', example: 'We met three Italian publishers at the Frankfurt book fair and promised to send them the manuscript the following week.' },
]

const DISCUSSION = [
  'What do you usually look for when you are buying a book?',
  'What are the advantages and disadvantages of reading a printed book vs an e-book?',
  'Have you read many books in English? How do you find it compared to reading in your native language?',
  ...
  'You are organising a book launch for a novel you love. What do you think could make it successful?',
]
...
const ANSWER_KEY: ReadonlyArray<{ sentence: string; answer: string }> = [
  ...
  { sentence: 'During __________, the writer was asked to cut a side character and make chapter four easier to follow.', answer: 'editing' },
  ...
  { sentence: 'During the __________ process, Gail found some typos and missing commas in Chapter 3.', answer: 'proofreading' },
  ...
  { sentence: 'Without the author\'s permission, posting whole chapters online would break __________ regulations.', answer: 'copyright' },
  ...
  { sentence: 'For most of the story, readers follow Maya, the __________, as she tries to save her family\'s restaurant.', answer: 'protagonist' },
  { sentence: 'The __________ took eight months, and Miguel found it challenging making some of the humour work in Spanish.', answer: 'translation' },
