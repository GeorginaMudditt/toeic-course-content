/**
 * Generate Publishing worksheet pronunciation audio via ElevenLabs TTS.
 * Saves to public/vocab-audio/publishing-vocab-audio/{word}.mp3
 *
 * Usage:
 *   npx tsx scripts/generate-publishing-vocab-tts.ts
 *   npx tsx scripts/generate-publishing-vocab-tts.ts --dry-run
 *   npx tsx scripts/generate-publishing-vocab-tts.ts --skip-existing
 */
...
const OUTPUT_DIR = join(process.cwd(), 'public', 'vocab-audio', 'publishing-vocab-audio')
const CACHE_DIR = join(process.cwd(), '.cache', 'publishing-vocab-audio')
...
const WORDS: ReadonlyArray<{ word: string; tts_text?: string; trim_prefix?: string }> = [
  ...
  { word: 'copyright' },
  { word: 'blurb' },
  { word: 'forthcoming title' },
  { word: 'advance' },
  { word: 'royalties', tts_text: 'royalties.' },
  { word: 'book launch' },
  { word: 'foreign rights' },
  { word: 'translation' },
  { word: 'print run' },
